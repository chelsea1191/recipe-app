...
///////////////////put/////////////////////
const updateRecipe = async (id, rating) => {
  const SQL = `UPDATE recipes SET rating = $2 WHERE id = $1 returning *;`;
  return (await client.query(SQL, [id, rating])).rows[0];
};
